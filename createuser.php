...
<head>
    ...
    <title>BANK OF SPAIN - Create User</title>
           ...
           <div class="card ">
             ...
             <div class="card-body bg-light">
                 <form action="" class="userform" method="post">
                   ...
                   <div class="form-group">
                     <input type="number" name="balance" class="form-control" placeholder="Balance (Euro €)" required>
                   </div>
                   <div class="text-center button">
                     <input type="submit" value="CREATE" name="submit" class="btn " style="font-size:1.2rem; ">
